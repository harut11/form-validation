...
$(document).ready(function () {
  ...
  var showPersons = function showPersons() {
    ...
    if (persons) {
      $.each(persons, function (key, value) {
        ...
        value.firstName, value.lastName, value.email, value.dof, value.phone, value.address, value.gender, value.work]).draw(false);
      });
    }
  };
  ...
  var showPerson = function showPerson() {
    ...
    table.row.add([person.firstName, person.lastName, person.email, person.dof, person.phone, person.address, person.gender, person.work]).draw(false);
  };
